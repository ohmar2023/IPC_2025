...
est <- readRDS("productos/02_viv_alquileres/02_pedido_secundario/02_estimaciones/estimaciones_1_2.rds")
...
export(tamanio, paste0(ruta, "tamanio_pedido_002_casas_0.10_001.xlsx"))
